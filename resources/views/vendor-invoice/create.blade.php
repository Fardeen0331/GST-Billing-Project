                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required type="text" name="invoice_no" class="form-control border-bottom">
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="">Invoice Date *</label>
                                                <input required type="date"  name="invoice_date" class="form-control border-bottom" id="validationCustom01">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" name="swift_code" class="form-control border-bottom" id="validationCustom01" placeholder="Enter SWIFT Code">
                                        ...
                                        <div class="row mt-0">
                                            <div class="col-md-12">
                                                <ul style="list-style: none;float: right;">
                                                    <li>
                                                        <b>Total Amount:</b> R <span type="text" id="totalDisplay">0</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
